...
Namespace WindowsFormsApplication24
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.myXtraTabbedMdiManager1 = New WindowsFormsApplication24.MyXtraTabbedMdiManager(Me.components)
			...
			Me.myXtraTabbedMdiManager1.UseDefaultPageImageSize = False
			Me.myXtraTabbedMdiManager1.UseFormIconAsPageImage = DevExpress.Utils.DefaultBoolean.True
			' 
			' Form1
			' 
